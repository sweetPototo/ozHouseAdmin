...
<div class="container">
	<div class="content-container">
		...
		<form name="f1" action="update_admin.do" class="flex-container" method="post">
	    	<div class="flex-row">
	...
	<div class="flex-subrow custom-button-row">
		...
		<div align="left" class="results-heading">
		    <font size="2">검색 결과</font>&nbsp;&nbsp;총 ${updateRequestListCount} 건
		</div>
		<div class="scroll flex-container content-table">
		    ...
		    <c:if test="${empty updateRequestListProduct}">
		        <div class="flex-row">
		            <div class="flex-cell" colspan="10">등록된 상품이 없습니다.</div>
		        </div>
		    </c:if>
		    <c:forEach var="dto" items="${updateRequestListProduct}">
		        <div class="flex-row">
...
<div class="flex-cell">
    <c:if test="${dto.product_approval_status=='ur'}">
        <button onclick="location.href='admin_update_product.do?product_num=${dto.product_num }'">확인</button> 
