...
<body onload="f.member_id.focus()">
	<div  align="center" class="login-wrapper" >
		<form name="f" method="post" id="login-form" action="admin_changePass.do">
 			<br><br><br>
			...
			<input type="password" tabindex="3" name="admin_passwd" placeholder="비밀번호를 입력해 주세요." class="box" placeholder="Enter password">
			</c:if>
			
			<br><br>
			<span class="title3">비밀번호</span>
	        <input type="password" tabindex="3" name="new_admin_passwd" placeholder="비밀번호를 입력해 주세요." class="box" id="password" oninput="checkPasswd2()">
			<span class="title3">비밀번호 확인</span>
			<input type="password" tabindex="4" placeholder="비밀번호를 정확하게 입력해 주세요." name="new_admin_passwd2" class="box" id="passwordCheck" oninput="checkPasswd()">
			...
			<input type="hidden" name="admin_id" value="${member_id}">
