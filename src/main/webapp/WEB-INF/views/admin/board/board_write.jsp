...
<div class="container">
	...
	<form name="f" action="admin_reqa.do?admin_QA_num=${admin_QA_num }" method="post" onsubmit="return validateForm()">
		<input type="hidden" name="admin_reQA_num" value="${admin_QA_num}">
			...
			<div class="flex-container">
				<div class="flex-row">
					...
					<div class="flex-cell-sub">
						<input type="text" name="admin_reQA_subject" class="box" size="40">
					</div>
				</div>
				<div class="flex-row">
					<div class="flex-cell">내 용</div>
					<div class="flex-cell-sub">
						<textarea name="admin_reQA_content" rows="11" cols="40" class="box"></textarea>
					</div>
				</div>
